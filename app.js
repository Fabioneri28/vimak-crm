...
let session=null, profile=null, company=null, cache={clients:[],leads:[],proposals:[],proposalItems:[],proposalModels:[],measurements:[],purchaseOrders:[],purchaseOrderItems:[],documentTemplates:[],productionProjects:[],cuttingPlans:[],sheetRemnants:[],integrations:[],suppliers:[],partners:[],afterSales:[],inputs:[]};
...
async function refreshCore(){
  const [c,l,p,pi,pm,m,po,poi,dt,pp,cp,sr,integ,s,pa,as,i]=await Promise.all([
